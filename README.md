# Streamdata.io API Gallery - Augmate Profiling
This is a repository for managing the profiling of Augmate. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of Augmate, including different links and artificats defining their operation.
...
Once there is an OpenAPI for Augmate, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
